...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', BASE_DIR / 'db.sqlite3') if DATABASE_ENGINE == 'django.db.backends.sqlite3' else os.getenv('DB_NAME', 'portfolio_db'),
...
CORS_ALLOWED_ORIGINS = [os.getenv('CORS_ALLOWED_ORIGIN', 'http://localhost:5173')]
